...
{
public:
	unsigned char                                      UnknownData_AR8A[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ARM9[0x28];                                    // 0x0068(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ML5I[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TUW9[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)

...
{
public:
	class UStaticMeshComponent*                        bsp_rock_small_01_d;                                       // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UStaticMeshComponent*                        bsp_rock_medium_01_e;                                      // 0x0418(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass bsp_beach_rocks_07.bsp_beach_rocks_07_C");
		return ptr;
	}

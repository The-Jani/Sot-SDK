...
public:
	...
	unsigned char                                      UnknownData_KTHJ[0x3];                                     // 0x1991(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4P4W[0x3];                                     // 0x1999(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

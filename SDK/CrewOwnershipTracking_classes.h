...
{
public:
	unsigned char                                      UnknownData_2YXT[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_POZF[0x10];                                    // 0x0160(0x0010) MISSED OFFSET (PADDING)

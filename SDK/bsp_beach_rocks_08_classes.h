...
{
public:
	class UStaticMeshComponent*                        bsp_rock_small_01_e;                                       // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UStaticMeshComponent*                        bsp_rock_medium_01_c;                                      // 0x0418(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	class UStaticMeshComponent*                        wsp_rock_xtra_small_a_01;                                  // 0x0438(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	class UStaticMeshComponent*                        wsp_rock_pebbles_f_02;                                     // 0x0468(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass bsp_beach_rocks_08.bsp_beach_rocks_08_C");
		return ptr;
	}

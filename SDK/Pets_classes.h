...
public:
	...
	unsigned char                                      UnknownData_81FM[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
public:
	float                                              TaskDuration;                                              // 0x0088(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_10ZM[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2Q1I[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4JA7[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_34IW[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5AM9[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FHangoutSpotId                              ForcedId;                                                  // 0x008C(0x0008) (Edit)
	unsigned char                                      UnknownData_LSO2[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QPA9[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9X2C[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7OR0[0xD0];                                    // 0x00D0(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A8DR[0x70];                                    // 0x00D8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClass*                                      PetType_Cached;                                            // 0x0148(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_GDPR[0x148];                                   // 0x0150(0x0148) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XYTC[0x20];                                    // 0x0948(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NM8B[0x4];                                     // 0x097C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VMQ6[0x8];                                     // 0x0990(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AKWE[0x4];                                     // 0x09CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5CQE[0x54];                                    // 0x09DC(0x0054) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_I1EK[0x3];                                     // 0x02C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PK3A[0x3];                                     // 0x02C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9ACP[0x23];                                    // 0x02D5(0x0023) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UPetPerchComponent*>                  PetPerchComponents;                                        // 0x02F8(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference)
	unsigned char                                      UnknownData_Z72M[0x10];                                    // 0x0308(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IYFK[0x1E];                                    // 0x031A(0x001E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XMND[0x10];                                    // 0x0340(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PJC9[0x18];                                    // 0x0550(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1EAT[0x17];                                    // 0x0599(0x0017) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GBYJ[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_H7T3[0x18];                                    // 0x0118(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DDL2[0x5];                                     // 0x015B(0x0005) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V98Z[0x4];                                     // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_8KSR[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KU9N[0x18];                                    // 0x0090(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1WDX[0x1A8];                                   // 0x0130(0x01A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SGR6[0x50];                                    // 0x02E0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DCM7[0x30];                                    // 0x07D0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0KFQ[0x4];                                     // 0x0804(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UTFT[0x6F];                                    // 0x0899(0x006F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OUMV[0x16];                                    // 0x090A(0x0016) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MY1O[0x10];                                    // 0x02E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FWRO[0x80];                                    // 0x00D0(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OS2R[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_NPFR[0x28];                                    // 0x00D0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U8TH[0x50];                                    // 0x0128(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6V30[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)

...
public:
	...
	unsigned char                                      UnknownData_QCC5[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MLD7[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QLQQ[0x1E];                                    // 0x0072(0x001E) MISSED OFFSET (PADDING)

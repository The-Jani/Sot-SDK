...
{
public:
	unsigned char                                      UnknownData_9264[0x8];                                     // 0x1968(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SBDN[0x4];                                     // 0x1A04(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3J7L[0x3];                                     // 0x1A39(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_ClothingCharles_PreCursedSails.BP_Campaign005_CursedSails_ClothingCharles_PreCursedSails_C");
		return ptr;
	}

...
public:
	...
	class UBP_Prompt_EmissarySecuredLootOnShip_C*      PromptCoordinator;                                         // 0x0468(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

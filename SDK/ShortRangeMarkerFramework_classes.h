...
{
public:
	unsigned char                                      UnknownData_GVER[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_GFFM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)

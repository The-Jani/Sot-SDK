...
{
public:
	unsigned char                                      UnknownData_0AQX[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_85WC[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XK5Y[0xA8];                                    // 0x0490(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_M6T3[0x60];                                    // 0x00C8(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IY3E[0x70];                                    // 0x0028(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_685O[0xA8];                                    // 0x0788(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_61I7[0x60];                                    // 0x0488(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZPQE[0xA8];                                    // 0x0430(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_01E8[0x8];                                     // 0x0628(0x0008) Fix Super Size
	unsigned char                                      UnknownData_KMRL[0xA0];                                    // 0x0630(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CUQJ[0xA8];                                    // 0x0490(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BW4O[0x1B0];                                   // 0x0088(0x01B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_7NFI[0xA8];                                    // 0x0028(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_521H[0x8];                                     // 0x0498(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K4IQ[0xA0];                                    // 0x04A8(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q5GP[0x10];                                    // 0x0550(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GY0Q[0x40];                                    // 0x0950(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QFFV[0x8];                                     // 0x05B8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_F1LG[0x10];                                    // 0x05C0(0x0010) MISSED OFFSET (PADDING)

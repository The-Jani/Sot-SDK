...
public:
	...
	unsigned char                                      UnknownData_T9ZZ[0x3];                                     // 0x1BC1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WFQ9[0x3];                                     // 0x1BC9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

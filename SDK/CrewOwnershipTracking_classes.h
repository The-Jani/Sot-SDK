...
{
public:
	unsigned char                                      UnknownData_2B2L[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SSJY[0x10];                                    // 0x0160(0x0010) MISSED OFFSET (PADDING)

...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Title_OOS_Rank3_001_EmissaryOfMysticMercenaries.Title_OOS_Rank3_001_EmissaryOfMysticMercenaries_C");
		return ptr;
	}

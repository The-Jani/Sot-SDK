...
{
public:
	unsigned char                                      UnknownData_A0GI[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UA4N[0x124];                                   // 0x005C(0x0124) MISSED OFFSET (PADDING)

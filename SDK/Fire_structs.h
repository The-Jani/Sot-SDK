...
struct FFireCellStateParticleTemplate
{
	...
	unsigned char                                      UnknownData_G2PN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OK22[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q6V0[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnData
{
	...
	unsigned char                                      UnknownData_5FRV[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnList
{
	...
	unsigned char                                      UnknownData_XZGW[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FReplicatedFireCellCharringData
{
	...
	unsigned char                                      UnknownData_QAOG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireGridCharringManager
{
	...
	unsigned char                                      UnknownData_0QBJ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QD70[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
struct FShipFireLightRelativeSpawnDesc : public FFireGridRelativeSpawnDesc
{
	...
	unsigned char                                      UnknownData_NMHT[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FShipFireLight
{
	...
	unsigned char                                      UnknownData_6NSI[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OY48[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VKZL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZVIW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6MGV[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FFireCellDesc
{
	...
	unsigned char                                      UnknownData_MEW7[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HQXA[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireDefaultVFXSpawnData
{
	...
	unsigned char                                      UnknownData_VTB6[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireParticleSystem
{
	...
	unsigned char                                      UnknownData_NCLI[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireMesh
{
	...
	unsigned char                                      UnknownData_GIUT[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FActorFireDamageParams
{
	...
	unsigned char                                      UnknownData_UXD0[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_8TK5[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FShipFireLightManager
{
	...
	unsigned char                                      UnknownData_4RC4[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HX73[0x18];                                    // 0x0128(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HQTI[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WXRU[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
...
struct FFireGridCellSelection
{
	...
	unsigned char                                      UnknownData_WY24[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

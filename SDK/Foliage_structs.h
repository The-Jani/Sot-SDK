...
struct FFoliageTypeObject
{
	...
	unsigned char                                      UnknownData_RPOT[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProceduralFoliageInstance
{
	...
	unsigned char                                      UnknownData_EXUN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GTR1[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JJP9[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HHFQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

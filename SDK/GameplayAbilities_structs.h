...
{
	unsigned char                                      UnknownData_134L[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L6HH[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G1A6[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FGameplayEventData
{
	...
	unsigned char                                      UnknownData_K10X[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FPredictionKey
{
	...
	unsigned char                                      UnknownData_PPIJ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9H9L[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityActivationInfo
{
	...
	unsigned char                                      UnknownData_V5BB[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifiedAttribute
{
	...
	unsigned char                                      UnknownData_EBLM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpecForRPC
{
	...
	unsigned char                                      UnknownData_9SXB[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CHKE[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5FNY[0xF];                                     // 0x0011(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_HQ53[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KSOF[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Z4Y8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_537X[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LS3G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V4W8[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FScalableFloat
{
	...
	unsigned char                                      UnknownData_EGFZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FCurveTableRowHandle                        Curve;                                                     // 0x0008(0x0010) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_PLBZ[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureDefinition
{
	...
	unsigned char                                      UnknownData_A5GY[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FAttributeBasedFloat
{
	...
	unsigned char                                      UnknownData_NDR0[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifierMagnitude
{
	...
	unsigned char                                      UnknownData_N6DU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayModifierInfo
{
	...
	unsigned char                                      UnknownData_IV30[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityTriggerData
{
	...
	unsigned char                                      UnknownData_KVIZ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityBindInfo
{
	...
	unsigned char                                      UnknownData_L2PI[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayCuePendingExecute
{
	...
	unsigned char                                      UnknownData_M0PL[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayCueNotifyData
{
	...
	unsigned char                                      UnknownData_G6F5[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayModifierEvaluatedData
{
	...
	unsigned char                                      UnknownData_XYC7[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZPEA[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayEffectCustomExecutionOutput
{
	...
	unsigned char                                      UnknownData_F3O8[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NV7J[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_JIRW[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpec
{
	...
	unsigned char                                      UnknownData_6YTU[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpecContainer
{
	...
	unsigned char                                      UnknownData_S742[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTagContainerAggregator
{
	...
	unsigned char                                      UnknownData_4AEX[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecDef
{
	...
	unsigned char                                      UnknownData_6439[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TG31[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpec
{
	...
	unsigned char                                      UnknownData_Q9ZM[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YPT1[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TEE2[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGameplayAbilitySpecDef>             GrantedAbilitySpecs;                                       // 0x0218(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_3J8L[0x50];                                    // 0x0228(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ZRG[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4989[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VSU5[0x5B];                                    // 0x02D5(0x005B) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QCOG[0x50];                                    // 0x00A8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FActiveGameplayEffect>               GameplayEffects_Internal;                                  // 0x00F8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_05NE[0x2C0];                                   // 0x0108(0x02C0) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityLocalAnimMontage
{
	...
	unsigned char                                      UnknownData_0WB8[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0010(0x0018)
...
struct FGameplayAbilityRepAnimMontage
{
	...
	unsigned char                                      UnknownData_M1HR[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributeMetaData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_ODX7[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JDOD[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WQ7V[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DIW2[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K85M[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FFEY[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0T84[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGameplayAbilityTargetingLocationInfo       SourceLocation;                                            // 0x0010(0x0070) (Edit, BlueprintVisible, ContainsInstancedReference)
...
{
	unsigned char                                      UnknownData_TMBG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F338[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IX4R[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KJLR[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	unsigned char                                      UnknownData_EDN1[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_HE2P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RGEF[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_891A[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecContainer : public FFastArraySerializer
{
	...
	unsigned char                                      UnknownData_0GQ3[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)

...
{
public:
	unsigned char                                      UnknownData_UIV2[0x4];                                     // 0x0A7C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_WKIT[0x7];                                     // 0x0A99(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z1I3[0x3];                                     // 0x0AA9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

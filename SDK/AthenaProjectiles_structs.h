...
struct FGlobalProjectileSettings
{
	...
	unsigned char                                      UnknownData_ZDV3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FThrottledProjectileTickPool
{
	...
	unsigned char                                      UnknownData_AEQ5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
struct FServerMigrationSerialisationDetailsTestsUStruct
{
	...
	unsigned char                                      UnknownData_DBTN[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FServerSettings
{
	...
	unsigned char                                      UnknownData_A10L[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZE44[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)

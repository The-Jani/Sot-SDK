...
struct FAchievementUpdatedEvent
{
	...
	unsigned char                                      UnknownData_9IZ6[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOnlineStoreCatalogItem
{
	...
	unsigned char                                      UnknownData_SGHC[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_4KUL[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)

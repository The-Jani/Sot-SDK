...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_ShopkeeperTyler_PreCursedSails.BP_Campaign005_CursedSails_ShopkeeperTyler_PreCursedSails_C");
		return ptr;
	}

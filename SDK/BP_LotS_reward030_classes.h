...
// BlueprintGeneratedClass BP_LotS_reward030.BP_LotS_reward030_C
// 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
class ABP_LotS_reward030_C : public AModalInteractionProxy
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_LotS_reward030.BP_LotS_reward030_C");
		return ptr;
	}

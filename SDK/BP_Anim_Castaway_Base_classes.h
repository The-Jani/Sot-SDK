...
public:
	...
	unsigned char                                      UnknownData_GXUH[0x3];                                     // 0x1CED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MK5U[0x2];                                     // 0x1CFA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
{
public:
	unsigned char                                      UnknownData_FV8S[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B59P[0x7F];                                    // 0x0449(0x007F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SHGL[0xC];                                     // 0x03EC(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5AFM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
public:
	...
	unsigned char                                      UnknownData_HJW5[0x48];                                    // 0x0038(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YUEQ[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_4124[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMovieSceneBindingOverrideData>      BindingData;                                               // 0x0030(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData_H6Q4[0x58];                                    // 0x0040(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OBCM[0x10];                                    // 0x0060(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1CY2[0x368];                                   // 0x0028(0x0368) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BDFA[0x7];                                     // 0x03C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FQVJ[0x10];                                    // 0x03E0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                          // 0x03F0(0x0028) (Protected)
	unsigned char                                      UnknownData_3U7H[0x248];                                   // 0x0418(0x0248) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VZQ4[0x2];                                     // 0x0082(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S9RY[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AZ3W[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZI6E[0x6];                                     // 0x02A2(0x0006) MISSED OFFSET (PADDING)

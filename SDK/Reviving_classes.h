...
{
public:
	unsigned char                                      UnknownData_7RA6[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OUVH[0x10];                                    // 0x0480(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BZ2F[0x7];                                     // 0x0491(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FSP7[0x13C];                                   // 0x04F8(0x013C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HCYT[0x1C];                                    // 0x0644(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J85R[0x4];                                     // 0x067C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EUQS[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_29P5[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4216[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               HasGivenUp;                                                // 0x0120(0x0001) (Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor)
	unsigned char                                      UnknownData_34KB[0x57];                                    // 0x0121(0x0057) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HBZC[0x18];                                    // 0x02E8(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OZ0C[0x10];                                    // 0x0118(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4OVL[0x6];                                     // 0x013A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8SRK[0xC];                                     // 0x0148(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               ReviveWindowIsOpen;                                        // 0x0154(0x0001) (Net, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_HT4E[0xD3];                                    // 0x0155(0x00D3) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStatus                                     RevivableStatus;                                           // 0x0228(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_CF5S[0x18];                                    // 0x0240(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZO8F[0x98];                                    // 0x00C8(0x0098) MISSED OFFSET (PADDING)

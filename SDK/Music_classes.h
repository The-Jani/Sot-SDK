...
{
public:
	unsigned char                                      UnknownData_2ARS[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YXL1[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H9ES[0x6];                                     // 0x02FA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnMusicZoneStarted;                                        // 0x0300(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData_95O6[0x60];                                    // 0x0310(0x0060) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H2NS[0xF];                                     // 0x0391(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N8FW[0x28];                                    // 0x0378(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9NCF[0xA8];                                    // 0x03D0(0x00A8) MISSED OFFSET (PADDING)

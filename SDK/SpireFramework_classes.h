...
{
public:
	unsigned char                                      UnknownData_IHGW[0x28];                                    // 0x0040(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7EPJ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z50V[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H4DY[0x50];                                    // 0x0100(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L10S[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3IUU[0x8];                                     // 0x0428(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3LNG[0x48];                                    // 0x0460(0x0048) MISSED OFFSET (PADDING)

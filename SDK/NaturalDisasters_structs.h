...
struct FVolcanoTargetCoolDown
{
	...
	unsigned char                                      UnknownData_IU04[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FVolcanoStateData
{
	...
	unsigned char                                      UnknownData_T3GE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Z2N4[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CBMT[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTarget
{
	...
	unsigned char                                      UnknownData_IYVX[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UTMJ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoTargetChances
{
	...
	unsigned char                                      UnknownData_V1M1[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BRX0[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoSetupDataEmbersEntry
{
	...
	unsigned char                                      UnknownData_MRUM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
struct FTreasuryWaveEncounter
{
	...
	unsigned char                                      UnknownData_CXA0[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FTU1[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S198[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)

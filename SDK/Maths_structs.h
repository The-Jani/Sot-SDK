...
struct FTimedBuffer
{
	unsigned char                                      UnknownData_3B4N[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FFixedStepInterpCurveVector2D
{
	...
	unsigned char                                      UnknownData_4JHU[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSpatialOffset
{
	...
	unsigned char                                      UnknownData_36RA[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E2LP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

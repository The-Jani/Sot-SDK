...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Title_MA_Rank2_001_EmissaryOfMerchantCommanders.Title_MA_Rank2_001_EmissaryOfMerchantCommanders_C");
		return ptr;
	}

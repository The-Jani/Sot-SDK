...
{
public:
	unsigned char                                      UnknownData_U5UZ[0x8];                                     // 0x05F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E7IG[0x1C];                                    // 0x060C(0x001C) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_O7L0[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_M4EY[0x50];                                    // 0x0640(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N4Z1[0xC];                                     // 0x0644(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TX22[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_346U[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_73H0[0xF8];                                    // 0x03D0(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YC2A[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5GUX[0x3];                                     // 0x050D(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GXSU[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y15C[0x48];                                    // 0x00D8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D55Y[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OCM9[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)

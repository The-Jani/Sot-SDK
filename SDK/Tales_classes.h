...
{
public:
	unsigned char                                      UnknownData_C1C2[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F445[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TXXV[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FIAC[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PGNY[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UScriptStruct*                               StructForCollector;                                        // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_JG75[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GYS0[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EIWX[0x8];                                     // 0x0608(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_BP5R[0x3];                                     // 0x0619(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DXZZ[0x4];                                     // 0x062C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_45EY[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O651[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1OLE[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I3KA[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AR0H[0x18];                                    // 0x0098(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OXNQ[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3SQC[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnCompleted;                                               // 0x0038(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	unsigned char                                      UnknownData_DL0G[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DNMD[0x20];                                    // 0x00B0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_XU3P[0x48];                                    // 0x00E8(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FTC8[0xC8];                                    // 0x0060(0x00C8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TQ7Z[0x58];                                    // 0x0068(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6KD1[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_492I[0x18];                                    // 0x0090(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_11QB[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UAN6[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z42E[0x18];                                    // 0x00A8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_54AB[0x20];                                    // 0x0030(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	uint32_t                                           InstancedLevelIndex;                                       // 0x0068(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_5SX4[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AYR1[0x50];                                    // 0x0088(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KRVU[0x18];                                    // 0x0088(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HOP9[0x18];                                    // 0x0090(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HVP3[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	class ASequencerCutSceneActor*                     SequencerCutSceneActor;                                    // 0x0090(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3UXG[0x28];                                    // 0x0098(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OAO9[0xA8];                                    // 0x0088(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8CSQ[0x30];                                    // 0x0088(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_01KL[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_M7ID[0x20];                                    // 0x0090(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JZ0C[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O2YK[0x90];                                    // 0x0088(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_P27J[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_N321[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A849[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4INX[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_BE6E[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZCQ5[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XXLS[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FQuestVariableVector                        Location;                                                  // 0x0038(0x0010) (Edit)
...
public:
	...
	unsigned char                                      UnknownData_XM40[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I8YB[0x2];                                     // 0x00BA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_0N4W[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LAHH[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	float                                              Radius;                                                    // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XLUM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FQuestVariableVector                        Location;                                                  // 0x0038(0x0010) (Edit)
...
public:
	...
	unsigned char                                      UnknownData_THGU[0x4];                                     // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               MarkAsCritical;                                            // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_77IL[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       CriticalActorLostMessage;                                  // 0x0058(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_D81I[0x20];                                    // 0x0051(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_1N5J[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       CriticalActorLostMessage;                                  // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_F1CZ[0x20];                                    // 0x0032(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_BL5L[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5ROC[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Feature;                                                   // 0x0054(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_YI6R[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SP7G[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
public:
	class UTaleQuestArrayEntrySelectionStrategy*       SelectionStrategy;                                         // 0x0088(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_B7HD[0x38];                                    // 0x0090(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B2WC[0x118];                                   // 0x00D0(0x0118) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OZD1[0x90];                                    // 0x0060(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QF6T[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)

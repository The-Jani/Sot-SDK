...
public:
	...
	unsigned char                                      UnknownData_MOCY[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KS3W[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RKYG[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)

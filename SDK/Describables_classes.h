...
{
public:
	unsigned char                                      UnknownData_UAE9[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               TooltipActiveOnBeginPlay;                                  // 0x0120(0x0001) (Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_HDPR[0x7];                                     // 0x0121(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       DescribableTooltipText;                                    // 0x0128(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_NBER[0x20];                                    // 0x0121(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               TooltipActive;                                             // 0x0160(0x0001) (Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor)
	unsigned char                                      UnknownData_DG3X[0x17];                                    // 0x0161(0x0017) MISSED OFFSET (PADDING)

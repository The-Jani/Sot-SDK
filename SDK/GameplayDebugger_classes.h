...
{
public:
	unsigned char                                      UnknownData_Q5DP[0x8];                                     // 0x0588(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_P8YI[0x4];                                     // 0x05A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z41I[0x10];                                    // 0x06C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6SHQ[0x10];                                    // 0x06F8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_198N[0x7];                                     // 0x0739(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      TargetActor;                                               // 0x0740(0x0008) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2VCK[0x70];                                    // 0x0748(0x0070) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_NF2U[0xD0];                                    // 0x03F0(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZXJZ[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J0QW[0x1E];                                    // 0x008A(0x001E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A0O0[0x28];                                    // 0x00E8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_29BG[0x30];                                    // 0x04C8(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WM72[0x4];                                     // 0x0404(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8M0A[0x1];                                     // 0x0427(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QASB[0x4E];                                    // 0x0432(0x004E) MISSED OFFSET (PADDING)

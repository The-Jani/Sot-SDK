...
{
	unsigned char                                      UnknownData_6FP0[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FWwiseEmitterCreationParams
{
	...
	unsigned char                                      UnknownData_YF28[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshWwiseEmitterData
{
	...
	unsigned char                                      UnknownData_U0K7[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshComponentAudioAssociation
{
	...
	unsigned char                                      UnknownData_JGT9[0x24];                                    // 0x0044(0x0024) MISSED OFFSET (PADDING)

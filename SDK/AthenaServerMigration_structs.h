...
{
	unsigned char                                      UnknownData_0SI5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MKAM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5KNZ[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YP64[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_54BM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9U9P[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ONUD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FServerMigrationHeartbeatEvent
{
	...
	unsigned char                                      UnknownData_84T7[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K6RC[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)

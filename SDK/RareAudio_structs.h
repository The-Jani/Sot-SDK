...
{
	unsigned char                                      UnknownData_PK8P[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FWwiseEmitterCreationParams
{
	...
	unsigned char                                      UnknownData_HVU3[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshWwiseEmitterData
{
	...
	unsigned char                                      UnknownData_4XNW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshComponentAudioAssociation
{
	...
	unsigned char                                      UnknownData_3ZN4[0x24];                                    // 0x0044(0x0024) MISSED OFFSET (PADDING)

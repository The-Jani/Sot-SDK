...
{
public:
	unsigned char                                      UnknownData_KB03[0x28];                                    // 0x0040(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VGEU[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_G6VH[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FPNO[0x50];                                    // 0x0100(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EGUO[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1ZPG[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FServerSpireInfo>                    ServerOnlySpireInfo;                                       // 0x0438(0x0010) (ZeroConstructor)
	TArray<struct FSpireInfo>                          SpireLevels;                                               // 0x0448(0x0010) (Net, ZeroConstructor, RepNotify)
	TArray<struct FSpireInfo>                          PreviousSpireLevels;                                       // 0x0458(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_2RKA[0x48];                                    // 0x0468(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	TArray<TWeakObjectPtr<class ASpireResource>>       SpireList;                                                 // 0x0440(0x0010) (ZeroConstructor, UObjectWrapper)

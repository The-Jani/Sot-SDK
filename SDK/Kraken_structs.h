...
struct FCoordinatedKrakenPhaseAssetEntry
{
	...
	unsigned char                                      UnknownData_DXFS[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4YHE[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5BLZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N28K[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SGU6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XZIZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8Y0W[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YHVH[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T9P4[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B07A[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C1PI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S670[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KHV2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UGTS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZVRB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventKrakenAnimatedTentacleAnimationStarted
{
	...
	unsigned char                                      UnknownData_R9U5[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PE1Z[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1GTD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingTentacleAnimationStateParams
{
	...
	unsigned char                                      UnknownData_J2J2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationState
{
	...
	unsigned char                                      UnknownData_2Q49[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateEvent
{
	...
	unsigned char                                      UnknownData_0XYF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateFragmentParams
{
	...
	unsigned char                                      UnknownData_NE4O[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoordinatedKrakenHeadAction
{
	...
	unsigned char                                      UnknownData_7QZG[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipHittingBehaviourImpactParams
{
	...
	unsigned char                                      UnknownData_5UYS[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KNSC[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWeightedProbabilityRangeOfRanges           NumZonesToDamage;                                          // 0x0068(0x0030) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_ZHZG[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipHittingBehaviourParams
{
	...
	unsigned char                                      UnknownData_DOQP[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleVFXParams
{
	...
	unsigned char                                      UnknownData_XBZM[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingTentacleParams
{
	...
	unsigned char                                      UnknownData_M7MQ[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_HPOQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FKrakenDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_1WQB[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FKrakenTentacleBehaviourActionChances
{
	...
	unsigned char                                      UnknownData_OB77[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_43BI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EXMU[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingHoldingStateTransitionChance
{
	...
	unsigned char                                      UnknownData_B29X[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingBehaviourParams : public FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_AOEY[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenServiceSpawnParams
{
	...
	unsigned char                                      UnknownData_BCM3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentaclesChanceParams
{
	...
	unsigned char                                      UnknownData_23GE[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleTransitionAnimation
{
	...
	unsigned char                                      UnknownData_G25C[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleStateAnimationMapping
{
	...
	unsigned char                                      UnknownData_TAWN[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourNamedTransform
{
	...
	unsigned char                                      UnknownData_BI2J[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWarningParams
{
	...
	unsigned char                                      UnknownData_XBIK[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E3VX[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationParams
{
	...
	unsigned char                                      UnknownData_K01J[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationWeightedParams
{
	...
	unsigned char                                      UnknownData_N1AQ[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapParams
{
	...
	unsigned char                                      UnknownData_V5PD[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YR2X[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHeavyAttackParams
{
	...
	unsigned char                                      UnknownData_RO4V[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourDamageParams
{
	...
	unsigned char                                      UnknownData_KXO2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHealthParams
{
	...
	unsigned char                                      UnknownData_H2AL[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
	class UClass*                                      ShipSize;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_S1UK[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenBehaviourParams
{
	...
	unsigned char                                      UnknownData_4ME7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleParams
{
	...
	unsigned char                                      UnknownData_Z9IZ[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenWeightedBehaviour
{
	...
	unsigned char                                      UnknownData_WU4Y[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FKrakenParams
{
	...
	unsigned char                                      UnknownData_ND5J[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P8D4[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenSpecialEvent
{
	...
	unsigned char                                      UnknownData_MWLH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_T8XD[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenTentacleAction
{
	...
	unsigned char                                      UnknownData_IQ84[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenAction
{
	...
	unsigned char                                      UnknownData_20EJ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

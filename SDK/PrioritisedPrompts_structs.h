...
struct FPrioritisedPrompt
{
	...
	unsigned char                                      UnknownData_IV5C[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_GYAJ[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FPromptEvaluation
{
	...
	unsigned char                                      UnknownData_NB3N[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPermanentPromptNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_3H7A[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)

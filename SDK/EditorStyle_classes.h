...
public:
	...
	unsigned char                                      UnknownData_46V1[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PYF4[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SBMG[0x4E];                                    // 0x0072(0x004E) MISSED OFFSET (PADDING)

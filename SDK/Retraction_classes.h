...
{
public:
	unsigned char                                      UnknownData_7ZPO[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V9TX[0x1];                                     // 0x00FF(0x0001) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PV88[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZE5Y[0x30];                                    // 0x00E0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VS87[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (PADDING)

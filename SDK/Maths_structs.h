...
struct FTimedBuffer
{
	unsigned char                                      UnknownData_OZO0[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FFixedStepInterpCurveVector2D
{
	...
	unsigned char                                      UnknownData_YPOT[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSpatialOffset
{
	...
	unsigned char                                      UnknownData_ZT26[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PG8X[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
{
public:
	unsigned char                                      UnknownData_4SBX[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VNPC[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0OAI[0x66];                                    // 0x02FA(0x0066) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GS50[0xF];                                     // 0x0381(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A7DC[0x28];                                    // 0x0368(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MX41[0xA8];                                    // 0x0430(0x00A8) MISSED OFFSET (PADDING)

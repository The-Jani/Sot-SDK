...
{
	unsigned char                                      UnknownData_LIAS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTaleQuestCargoRunContractItem
{
	...
	unsigned char                                      UnknownData_RDE7[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FTaleQuestDeliveryRequest
{
	...
	unsigned char                                      UnknownData_J94J[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTrackedActorData
{
	...
	unsigned char                                      UnknownData_EDRU[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FCriticalActorDelegateData
{
	...
	unsigned char                                      UnknownData_BFCZ[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_3PK0[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FPhasedActor
{
	...
	unsigned char                                      UnknownData_KYDI[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FPhasedItem
{
	...
	unsigned char                                      UnknownData_N7SL[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FTaleQuestDeliverableItem
{
	...
	unsigned char                                      UnknownData_B1QH[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTaleQuestDesc : public FQuestDesc
{
	...
	unsigned char                                      UnknownData_UUEN[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_60LG[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      CriticalActor;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_860P[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5TWC[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UH6X[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_Z375[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UTexture*                                    Icon;                                                      // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_7VN7[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

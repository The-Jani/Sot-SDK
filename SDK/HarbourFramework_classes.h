...
{
public:
	unsigned char                                      UnknownData_H3Q1[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              HarbourRadiusInCentimetres;                                // 0x02B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_85NY[0x24];                                    // 0x02BC(0x0024) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TXMI[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)

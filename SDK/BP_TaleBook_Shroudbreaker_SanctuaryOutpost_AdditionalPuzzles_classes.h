...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_SanctuaryOutpost_AdditionalPuzzles.BP_TaleBook_Shroudbreaker_SanctuaryOutpost_AdditionalPuzzles_C");
		return ptr;
	}

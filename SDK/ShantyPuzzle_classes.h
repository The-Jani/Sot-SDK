...
{
public:
	unsigned char                                      UnknownData_LVX5[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RHZK[0x6];                                     // 0x02D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QKS1[0xC0];                                    // 0x0300(0x00C0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TVK3[0x20];                                    // 0x0580(0x0020) MISSED OFFSET (PADDING)

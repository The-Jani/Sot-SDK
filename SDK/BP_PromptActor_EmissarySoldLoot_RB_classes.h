...
public:
	...
	class UBP_Prompt_EmissarySoldLoot_C*               PromptCoordinator;                                         // 0x0490(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

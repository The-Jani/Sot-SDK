...
{
public:
	unsigned char                                      UnknownData_WMI4[0x38];                                    // 0x03D0(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class APlayerStart*>                        CustomPlayerStarts;                                        // 0x0408(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_AIOI[0x50];                                    // 0x0418(0x0050) MISSED OFFSET (PADDING)

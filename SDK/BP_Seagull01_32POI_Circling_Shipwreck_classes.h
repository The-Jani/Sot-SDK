...
{
public:
	class UWwiseEmitterComponent*                      WwiseEmitter2;                                             // 0x0428(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	class UStaticMeshComponent*                        wil_seagull_01_ProcAnim32;                                 // 0x0440(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)

...
{
	unsigned char                                      UnknownData_BQEJ[0xE0];                                    // 0x0000(0x00E0) MISSED OFFSET (PADDING)
...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_J35U[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_V6NJ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

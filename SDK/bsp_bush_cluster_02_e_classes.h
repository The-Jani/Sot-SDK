...
{
public:
	class UStaticMeshComponent*                        StaticMesh6;                                               // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass bsp_bush_cluster_02_e.bsp_bush_cluster_02_e_C");
		return ptr;
	}

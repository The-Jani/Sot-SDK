...
struct FStatus
{
	...
	unsigned char                                      UnknownData_VQ0Q[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FDelayedStatusEffect
{
	...
	unsigned char                                      UnknownData_YUYX[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FActiveStatusEffect
{
	...
	unsigned char                                      UnknownData_KR49[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0TWR[0x17];                                    // 0x0039(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5J30[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)

...
{
	unsigned char                                      UnknownData_XYEP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCleanlinessInfo
{
	...
	unsigned char                                      UnknownData_YSIQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
{
public:
	unsigned char                                      UnknownData_KOOJ[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4R6M[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B276[0x66];                                    // 0x02FA(0x0066) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y6VV[0xF];                                     // 0x0381(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XWKM[0x28];                                    // 0x0368(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V4RM[0xA8];                                    // 0x0428(0x00A8) MISSED OFFSET (PADDING)

...
{
public:
	unsigned char                                      UnknownData_XBDB[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WMMN[0x2];                                     // 0x043E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U9M9[0x2];                                     // 0x0452(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AIYI[0x4];                                     // 0x045C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WB7F[0x3C];                                    // 0x04B4(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_E5L8[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)

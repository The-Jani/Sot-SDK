...
// 0x0060 (FullSize[0x0668] - InheritedSize[0x0608])
...
public:
	...
	class UWwiseEvent*                                 SFX_IdleLoopPlay;                                          // 0x0638(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	class UWwiseEvent*                                 SFX_IdleLoopStop;                                          // 0x0640(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	struct FWwiseEmitter                               InnkeeperEmitter;                                          // 0x0648(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)

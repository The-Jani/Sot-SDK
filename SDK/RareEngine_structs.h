...
struct FMemoryVisualiserStat
{
	...
	unsigned char                                      UnknownData_88GP[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMemoryVisualiserClass
{
	...
	unsigned char                                      UnknownData_403Q[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRD7[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FMemoryVisualiserCategory
{
	...
	unsigned char                                      UnknownData_QN5F[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TQGW[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)

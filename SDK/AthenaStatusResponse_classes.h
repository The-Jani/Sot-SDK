...
public:
	...
	unsigned char                                      UnknownData_42DM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QKMF[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MYR4[0x20];                                    // 0x0050(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OM3M[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)

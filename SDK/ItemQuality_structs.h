...
struct FPerComanyItemQualityEntry
{
	...
	unsigned char                                      UnknownData_UJWI[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FComplexItemQualityEntry
{
	...
	unsigned char                                      UnknownData_9E4Q[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

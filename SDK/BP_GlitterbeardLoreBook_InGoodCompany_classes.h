...
// BlueprintGeneratedClass BP_GlitterbeardLoreBook_InGoodCompany.BP_GlitterbeardLoreBook_InGoodCompany_C
// 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
class ABP_GlitterbeardLoreBook_InGoodCompany_C : public AModalInteractionProxy
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_GlitterbeardLoreBook_InGoodCompany.BP_GlitterbeardLoreBook_InGoodCompany_C");
		return ptr;
	}

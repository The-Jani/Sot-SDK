...
{
public:
	unsigned char                                      UnknownData_4022[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClass*                                      RowboatClass;                                              // 0x03D8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_RD65[0x50];                                    // 0x03E0(0x0050) MISSED OFFSET (PADDING)

...
struct FBeachNPCSpawnFlowNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_PO78[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTutorialStepEndedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_Z96T[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_60LA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FContextualTutorialPromptDesc
{
	...
	unsigned char                                      UnknownData_999D[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)

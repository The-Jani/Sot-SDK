...
{
public:
	unsigned char                                      UnknownData_IY6Z[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class ADebugMenu*                                  DebugMenuInstance;                                         // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_TJ1L[0x20];                                    // 0x00F8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HXB4[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JAOL[0x60];                                    // 0x0428(0x0060) MISSED OFFSET (PADDING)

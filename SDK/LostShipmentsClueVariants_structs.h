...
struct FTextEntryWithLayout
{
	...
	unsigned char                                      UnknownData_RQVL[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMapRadialIconData
{
	...
	unsigned char                                      UnknownData_R699[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FExistingNPCToPhasedNPC
{
	...
	unsigned char                                      UnknownData_V2CN[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_5OFZ[0x4];                                     // 0x0020(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FClueDestinationToTextIndex
{
	...
	unsigned char                                      UnknownData_PTCM[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FClueDestinationChoice
{
	...
	unsigned char                                      UnknownData_LH9S[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FGenderSpecificTextPairings
{
	...
	unsigned char                                      UnknownData_3PD4[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       FeminineClueDestinationDescription;                        // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_OAEO[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

...
{
public:
	unsigned char                                      UnknownData_5WI3[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_INQF[0x10];                                    // 0x0480(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6KYX[0x7];                                     // 0x0491(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X50K[0x13C];                                   // 0x04F8(0x013C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8780[0x1C];                                    // 0x0644(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6MXE[0x4];                                     // 0x067C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_K5SJ[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPMN[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MUL1[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               HasGivenUp;                                                // 0x0120(0x0001) (Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor)
	unsigned char                                      UnknownData_OCGK[0x57];                                    // 0x0121(0x0057) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DUHM[0x18];                                    // 0x02E8(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9QCJ[0x10];                                    // 0x0118(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8549[0x6];                                     // 0x013A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9EDY[0xC];                                     // 0x0148(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               ReviveWindowIsOpen;                                        // 0x0154(0x0001) (Net, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_OEE0[0xD3];                                    // 0x0155(0x00D3) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStatus                                     RevivableStatus;                                           // 0x0228(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_KR1B[0x18];                                    // 0x0240(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EJF4[0x98];                                    // 0x00C8(0x0098) MISSED OFFSET (PADDING)

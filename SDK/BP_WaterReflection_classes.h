...
{
public:
	class UPlanarReflectionPlaneComponent*             PlanarReflectionPlane;                                     // 0x0428(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)

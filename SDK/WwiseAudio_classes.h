...
{
public:
	unsigned char                                      UnknownData_MDBO[0xA8];                                    // 0x0028(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VL7P[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AV1Q[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4BEI[0xA];                                     // 0x0046(0x000A) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GY84[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_N3LC[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZGZ1[0xC0];                                    // 0x0028(0x00C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWwiseAudioReverbPresets                    ReverbPresetSettings;                                      // 0x00E8(0x0064) (Edit, Config)
	unsigned char                                      UnknownData_0IQG[0x4];                                     // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I1XR[0x4];                                     // 0x0314(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DLU8[0x50];                                    // 0x0330(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_4JXN[0x2C];                                    // 0x003C(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JDFV[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L4HQ[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UF2P[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MWUY[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)

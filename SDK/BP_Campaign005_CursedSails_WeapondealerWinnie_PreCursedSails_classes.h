...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_WeapondealerWinnie_PreCursedSails.BP_Campaign005_CursedSails_WeapondealerWinnie_PreCursedSails_C");
		return ptr;
	}

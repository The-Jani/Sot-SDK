...
{
public:
	unsigned char                                      UnknownData_KCE6[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_1RBA[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)

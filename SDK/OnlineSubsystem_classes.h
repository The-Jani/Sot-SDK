...
public:
	...
	unsigned char                                      UnknownData_CDUB[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_N570[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (PADDING)

...
public:
	...
	unsigned char                                      UnknownData_J02Z[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MA0R[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
{
public:
	unsigned char                                      UnknownData_38SM[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_S8MZ[0x20];                                    // 0x0448(0x0020) MISSED OFFSET (PADDING)

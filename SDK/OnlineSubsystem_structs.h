...
struct FOnlineStoreCatalogItem
{
	...
	unsigned char                                      UnknownData_QQFQ[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest
{
	...
	unsigned char                                      UnknownData_QDFR[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAchievementUpdatedEvent
{
	...
	unsigned char                                      UnknownData_ZYIY[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

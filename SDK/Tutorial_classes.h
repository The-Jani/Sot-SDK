...
public:
	...
	unsigned char                                      UnknownData_UM3K[0x1C];                                    // 0x00F4(0x001C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z4EU[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_9ICZ[0xA8];                                    // 0x0038(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OB0F[0x38];                                    // 0x00E8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5XPL[0x6];                                     // 0x00CA(0x0006) MISSED OFFSET (PADDING)

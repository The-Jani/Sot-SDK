...
public:
	...
	unsigned char                                      UnknownData_CF83[0x3];                                     // 0x1BC1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_42C2[0x3];                                     // 0x1BC9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

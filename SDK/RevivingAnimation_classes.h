...
{
public:
	unsigned char                                      UnknownData_5MXB[0x8];                                     // 0x0440(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7GC2[0x1D];                                    // 0x0473(0x001D) MISSED OFFSET (PADDING)

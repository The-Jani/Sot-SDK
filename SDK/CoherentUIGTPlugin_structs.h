...
struct FCoherentUIGTLoadingScreenSettings
{
	...
	unsigned char                                      UnknownData_KXVH[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoherentUIGTViewInfo
{
	...
	unsigned char                                      UnknownData_JOOP[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function bsp_torch_b.bsp_torch_b_C.UserConstructionScript");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function bsp_torch_b.bsp_torch_b_C.ReceiveBeginPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function bsp_torch_b.bsp_torch_b_C.ExecuteUbergraph_bsp_torch_b");

...
{
	unsigned char                                      UnknownData_RYEP[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MRFM[0x1];                                     // 0x0031(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U8UA[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_85O4[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QASC[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FLayerActorStats
{
	...
	unsigned char                                      UnknownData_PBMH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0CMC[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_94RR[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5055[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRichCurveKey
{
	...
	unsigned char                                      UnknownData_UILL[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRichCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_UP4X[0x6];                                     // 0x005A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JJVU[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TLO9[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData_MDTF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData_QI21[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7RDK[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FRepMovement
{
	...
	unsigned char                                      UnknownData_8IGM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData_L22J[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1DLX[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (PADDING)
...
struct FSimulatedRootMotionReplicatedMove
{
	...
	unsigned char                                      UnknownData_9KAJ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionMovementParams
{
	...
	unsigned char                                      UnknownData_2970[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              BlendWeight;                                               // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3DI2[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBasedMovementInfo
{
	...
	unsigned char                                      UnknownData_7RT8[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimTickRecord
{
	...
	unsigned char                                      UnknownData_LN2P[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LENK[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XD05[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I23T[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_VN0N[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XHNW[0x2];                                     // 0x009A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4338[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IDJO[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FPlayerAmbientLightOverrideSettings
{
	...
	unsigned char                                      UnknownData_7VJ6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SU71[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedBlendable
{
	...
	unsigned char                                      UnknownData_OQM0[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRainPostProcessSettings
{
	...
	unsigned char                                      UnknownData_FFU0[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZB5[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PI6Q[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
struct FLPVCascadeSettings
{
	...
	unsigned char                                      UnknownData_9RBM[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T758[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      UnknownData_FS4M[0x1];                                     // 0x0013(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IJ7U[0x3];                                     // 0x02F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4H7S[0x3];                                     // 0x0339(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QZ3M[0x4];                                     // 0x037C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q7H5[0x3];                                     // 0x0389(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W162[0x3];                                     // 0x03E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AHGK[0x3];                                     // 0x03FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZB0X[0x3];                                     // 0x0515(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_77CJ[0x8];                                     // 0x0538(0x0008) MISSED OFFSET (PADDING)
...
struct FMinimalViewInfo
{
	...
	unsigned char                                      UnknownData_GB5V[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6C1S[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KJTS[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4DOL[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPostProcessSettings                        PostProcessSettings;                                       // 0x0050(0x0540) (BlueprintVisible)
	unsigned char                                      UnknownData_PJHS[0x10];                                    // 0x0590(0x0010) MISSED OFFSET (PADDING)
...
struct FMovementProperties
{
	...
	unsigned char                                      UnknownData_PY2O[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FNavAgentProperties : public FMovementProperties
{
	...
	unsigned char                                      UnknownData_IH6L[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1N5G[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FFindFloorResult
{
	...
	unsigned char                                      UnknownData_U12I[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData_3KMP[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FStatColorMapping
{
	...
	unsigned char                                      UnknownData_G6HR[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData_0NEC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FWalkableSlopeOverride
{
	...
	unsigned char                                      UnknownData_M6QD[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_8NUO[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FOverlapInfo
{
	unsigned char                                      UnknownData_BGOT[0x84];                                    // 0x0000(0x0084) MISSED OFFSET (PADDING)
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      UnknownData_JVZZ[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData_6I8C[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N5RW[0x8];                                     // 0x05B8(0x0008) MISSED OFFSET (PADDING)
...
struct FCameraCacheEntry
{
	...
	unsigned char                                      UnknownData_O4A6[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_X7E7[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveForceFeedbackEffect
{
	...
	unsigned char                                      UnknownData_IEA6[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownData_DVT2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ARQK[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FLevelStreamingStatusUpdateInfo
{
	...
	unsigned char                                      UnknownData_ZXVQ[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FReverbSettings
{
	...
	unsigned char                                      UnknownData_6E3Q[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_09TD[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteriorSettings
{
	...
	unsigned char                                      UnknownData_BE8A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      UnknownData_3514[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EVQU[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZU6G[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
...
struct FExternalMip
{
	...
	unsigned char                                      UnknownData_TMYJ[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FDebugTextInfo
{
	...
	unsigned char                                      UnknownData_5Q03[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     OrigActorLocation;                                         // 0x0040(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_NRWJ[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0IPM[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3Z4Q[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FPaintedVertex>                      PaintedVertices;                                           // 0x0010(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_6SHN[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FLightmassMaterialInterfaceSettings
{
	...
	unsigned char                                      UnknownData_VI18[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LSDK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialInput
{
	...
	unsigned char                                      UnknownData_3Z4R[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScalarMaterialInput : public FMaterialInput
{
	...
	unsigned char                                      UnknownData_MR9Z[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD (NoDestructor)
	unsigned char                                      UnknownData_4DAE[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DSVA[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FExpressionInput
{
	class UMaterialExpression*                         Expression;                                                // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                OutputIndex;                                               // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_4HIN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     InputName;                                                 // 0x0010(0x0010) (ZeroConstructor, HasGetValueTypeHash)
	int                                                Mask;                                                      // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                MaskR;                                                     // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                MaskG;                                                     // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD (NoDestructor)
	unsigned char                                      UnknownData_CGC8[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD (NoDestructor)
	unsigned char                                      UnknownData_IUNY[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialRelevance
{
	...
	unsigned char                                      UnknownData_WSRY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	uint16_t                                           ShadingModelMask;                                          // 0x0004(0x0002) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QWZ4[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_57VS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FEmitterPointData
{
	...
	unsigned char                                      UnknownData_ID51[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData_2KNY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7JUC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	unsigned char                                      UnknownData_870W[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9RGR[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VVKE[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WJSC[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      ForceResolution : 1;                                       // 0x0028(0x0001) BIT_FIELD (Edit, NoDestructor)
	unsigned char                                      UnknownData_1NPQ[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A2SB[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      DisableTransition : 1;                                     // 0x0030(0x0001) BIT_FIELD (Edit, NoDestructor)
	unsigned char                                      UnknownData_AZS5[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7QPQ[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K3AF[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FUPO[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (PADDING)
...
struct FFontParameterValue
{
	...
	unsigned char                                      UnknownData_8JFO[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FExpressionOutput
{
	...
	unsigned char                                      UnknownData_U4AW[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FEventGraphFastCallPair
{
	...
	unsigned char                                      UnknownData_II78[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData_9UGF[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FNavAgentSelector
{
	...
	unsigned char                                      UnknownData_XS3L[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData_BPW8[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FForceFeedbackChannelDetails
{
	...
	unsigned char                                      UnknownData_MXJX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavigationFilterArea
{
	...
	unsigned char                                      UnknownData_M7VF[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FNavigationFilterFlags
{
	...
	unsigned char                                      UnknownData_KPWS[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FSupportedAreaData
{
	...
	unsigned char                                      UnknownData_0FIX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData_QJEM[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MOEV[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AW65[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData_YPY4[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                LODBias;                                                   // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ESKN[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G2O2[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDistributionLookupTable
{
	...
	unsigned char                                      UnknownData_O6KT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V4VV[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FFuncStatEntry
{
	...
	unsigned char                                      UnknownData_6G9Q[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FSpikeStatEntry
{
	...
	unsigned char                                      UnknownData_YAHK[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_AE20[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_JCAW[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CCCA[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Scale3D;                                                   // 0x0004(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_YC2F[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       CollisionProfileName;                                      // 0x0014(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_WEK2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IFXB : 1;                                      // 0x0050(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_NPQ2 : 1;                                      // 0x0052(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_PGE3[0x1];                                     // 0x0053(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4SSX[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UDMW[0x37];                                    // 0x00C9(0x0037) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1B04[0x68];                                    // 0x0114(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_SY7O[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_9YPX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData_R6XI[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FBoneMirrorInfo
{
	...
	unsigned char                                      UnknownData_4Q53[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FTriangleSortSettings
{
	...
	unsigned char                                      UnknownData_APM0[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneReference
{
	...
	unsigned char                                      UnknownData_WD6Z[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FSimplygonChannelCastingSettings
{
	...
	unsigned char                                      UnknownData_VMPO[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FClothingAssetData
{
	...
	unsigned char                                      UnknownData_N77N[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_T1N6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W520[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RD4L[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SS35[0x1];                                     // 0x008B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_98AT[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A826[0x3];                                     // 0x009D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E7BH[0x1];                                     // 0x00A7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y03W[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JEGQ[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7CND[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C715[0xA];                                     // 0x0106(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GX4K[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X4L7[0x18];                                    // 0x0148(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_19KE[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FSingleAnimationPlayData
{
	...
	unsigned char                                      UnknownData_RZX3[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XX0F[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInterpControlPoint
{
	...
	unsigned char                                      UnknownData_50YM[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6VQI[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       LastObservedName;                                          // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_W9RZ[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSimplygonMaterialLODSettings
{
	...
	unsigned char                                      UnknownData_KVNK[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DEIX[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6KK1[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	bool                                               bActive;                                                   // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_YNAA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M9HA[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G023[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H3P8[0x5];                                     // 0x0023(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData_26H6[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XMIZ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bScaleVelocityByParamValue : 1;                            // 0x0010(0x0001) BIT_FIELD (Edit, NoDestructor)
	unsigned char                                      UnknownData_FO9C[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RN0I[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FAlphaBlend
{
	...
	unsigned char                                      UnknownData_4SSD[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MMSV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData_WJ3P[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSlotEvaluationPose
{
	...
	unsigned char                                      UnknownData_KS5A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_8CRQ[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_UH01[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W63E[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IY8H[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ALLL[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      UnknownData_SLIS[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModulatorContinuousParams
{
	...
	unsigned char                                      UnknownData_8DQD[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_AAIG[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimSegment
{
	...
	unsigned char                                      UnknownData_OILF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBranchingPointMarker
{
	...
	unsigned char                                      UnknownData_BDJQ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FAttenuationSettings
{
	...
	unsigned char                                      UnknownData_6ZU3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_99K2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3LIN[0x2];                                     // 0x008A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SJ6T[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UON0[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData_P19X[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                IntParam;                                                  // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_IEA8[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEngineShowFlagsSetting
{
	...
	unsigned char                                      UnknownData_GE71[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData_OHO1[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FTimelineFloatTrack
{
	...
	unsigned char                                      UnknownData_0TD4[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FTimelineLinearColorTrack
{
	...
	unsigned char                                      UnknownData_9F1S[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      UnknownData_2BBH[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FNavGraphNode
{
	...
	unsigned char                                      UnknownData_JOGE[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FFFTWaterComponentWaveParticleType
{
	...
	unsigned char                                      UnknownData_W4N7[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFFTWaterComponentIntersectParticleType
{
	...
	unsigned char                                      UnknownData_NV0D[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMurkyRegion
{
	...
	unsigned char                                      UnknownData_IQ19[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LQRT[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialSpriteElement
{
	...
	unsigned char                                      UnknownData_OAUC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HV4L[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCustomChannelSetup
{
	...
	unsigned char                                      UnknownData_34QW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y20D[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6XUG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E904[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       FunctionNameToBind;                                        // 0x0034(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_5NS9[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FHIKBoneTransform
{
	...
	unsigned char                                      UnknownData_RT58[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownData_T1Y1[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyState
{
	...
	unsigned char                                      UnknownData_NKWE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_70CV[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FEditedDocumentInfo
{
	...
	unsigned char                                      UnknownData_7OIW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData_9SXZ[0x20];                                    // 0x0078(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData_CY1A[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_87J9[0xF0];                                    // 0x0000(0x00F0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G4T7[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QYFG[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CL83[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XHGO[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelViewportInfo
{
	...
	unsigned char                                      UnknownData_C4QG[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialSimplificationSettings
{
	...
	unsigned char                                      UnknownData_EVXC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q7XH[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PKRJ[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LJ7R[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      UnknownData_3QFI[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPSE[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HR1K[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_84JD[0x2];                                     // 0x00AA(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5QBB[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YB89[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P6UV[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFFTWaterComponentParticleParams
{
	...
	unsigned char                                      UnknownData_QIJF[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFFTWaterComponentParams
{
	...
	unsigned char                                      UnknownData_LXQC[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H9ZE[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData_V2VH[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FCollisionResponseTemplate
{
	...
	unsigned char                                      UnknownData_HZE9[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       ObjectTypeName;                                            // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_PP7N[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CFVW[0x27];                                    // 0x0039(0x0027) MISSED OFFSET (PADDING)
...
struct FRigTransformConstraint
{
	...
	unsigned char                                      UnknownData_TJO5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMergedCollisionComponentStaticMeshInstanceData
{
	...
	unsigned char                                      UnknownData_41OJ[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GEEX[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V0VV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimerHandle
{
	unsigned char                                      UnknownData_JY62[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FDebugFloatHistory
{
	...
	unsigned char                                      UnknownData_0DFF[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FFormatTextArgument
{
	...
	unsigned char                                      UnknownData_BKUU[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       TextValue;                                                 // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible, DisableEditOnTemplate)
	unsigned char                                      UnknownData_65VN[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBakedStateExitTransition
{
	...
	unsigned char                                      UnknownData_IPWE[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedAnimationState
{
	...
	unsigned char                                      UnknownData_KU40[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7GPS[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData_SQZ3[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_08Q9[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData_EGXL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKShapeElem
{
	unsigned char                                      UnknownData_OXB5[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FKBoxElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_EDPO[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CS2T[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FVector                                     Center;                                                    // 0x0020(0x000C) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_WV5P[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FQuat                                       Orientation;                                               // 0x0030(0x0010) (Edit, EditConst, IsPlainOldData, NoDestructor)
	...
	unsigned char                                      UnknownData_1A39[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
struct FTimeline
{
	...
	unsigned char                                      UnknownData_U467[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTTW[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5SSB[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XTXJ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompressedOffsetData
{
	...
	unsigned char                                      UnknownData_XKF9[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FBlendParameter
{
	...
	unsigned char                                      UnknownData_URVF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInterpolationParameter
{
	...
	unsigned char                                      UnknownData_SGEZ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FBlendSampleData
{
	...
	unsigned char                                      UnknownData_QN88[0x14];                                    // 0x000C(0x0014) MISSED OFFSET (PADDING)
...
struct FBlendFilter
{
	unsigned char                                      UnknownData_E41O[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VB36[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FTextureRenderData
{
	...
	unsigned char                                      UnknownData_Y22A[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInstancedNavMesh
{
	...
	unsigned char                                      UnknownData_MJOX[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAudioQualitySettings
{
	...
	unsigned char                                      UnknownData_AIRJ[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                MaxChannels;                                               // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3M88[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPhysicalSurfaceName
{
	...
	unsigned char                                      UnknownData_HWLZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FDominanceGroupPair
{
	...
	unsigned char                                      UnknownData_HTF4[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDominanceGroupName
{
	...
	unsigned char                                      UnknownData_O0IK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FBlendSample
{
	...
	unsigned char                                      UnknownData_C0KC[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FKeyBind
{
	...
	unsigned char                                      UnknownData_3WIE[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FInputAxisProperties
{
	...
	unsigned char                                      UnknownData_MXH1[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      UnknownData_U1R6[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FInputAxisKeyMapping
{
	...
	unsigned char                                      UnknownData_VWU4[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HWRJ[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4A6T[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3ESM[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownData_2MNB[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_INTU[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ET2A[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       MenuDescription;                                           // 0x0008(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_WPWR[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_0QDB[0x20];                                    // 0x0050(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       Keywords;                                                  // 0x0088(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_7763[0x20];                                    // 0x0088(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FScreenMessageString
{
	...
	unsigned char                                      UnknownData_A9YN[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownData_1SEK[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      UnknownData_0A0T[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNamedNetDriver
{
	...
	unsigned char                                      UnknownData_O136[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FURL
{
	...
	unsigned char                                      UnknownData_MUQF[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZDA8[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EMVW[0xE0];                                    // 0x0000(0x00E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LFZH[0x10];                                    // 0x01D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                           // 0x01E8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_L3BR[0x18];                                    // 0x01F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROE8[0x48];                                    // 0x0250(0x0048) MISSED OFFSET (PADDING)
...
struct FActiveHapticFeedbackEffect
{
	...
	unsigned char                                      UnknownData_KSHJ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FPoseLinkBase
{
	...
	unsigned char                                      UnknownData_2KVG[0x14];                                    // 0x0004(0x0014) MISSED OFFSET (PADDING)
...
struct FEditorMapPerformanceTestDefinition
{
	...
	unsigned char                                      UnknownData_OC57[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData_N8VV[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZD55[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ND2N[0x20];                                    // 0x0050(0x0020) MISSED OFFSET (PADDING)
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData_TGPG[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FToggleTrackKey
{
	...
	unsigned char                                      UnknownData_VOPH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownData_DLMZ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVisibilityTrackKey
{
	...
	unsigned char                                      UnknownData_JSIC[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FPrimitiveMaterialRef
{
	...
	unsigned char                                      UnknownData_HK8Z[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSoundGroup
{
	...
	unsigned char                                      UnknownData_9FPY[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9AW3[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubtitleCue
{
	...
	unsigned char                                      UnknownData_P0OZ[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              Time;                                                      // 0x0038(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_PWXO[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FLocalizedSubtitle
{
	...
	unsigned char                                      UnknownData_IKP6[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSoundClassProperties
{
	...
	unsigned char                                      UnknownData_7R79[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VX0U[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NVZL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MYTN[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData_GAZ5[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_INJH[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHIKElements
{
	unsigned char                                      UnknownData_N2WH[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
struct FSubTrackGroup
{
	...
	unsigned char                                      UnknownData_B2SO[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSupportedSubTrackInfo
{
	...
	unsigned char                                      UnknownData_NB4N[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData_YCKN[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LFLG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2HTV[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ADQA[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EU73[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8JS7[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimationRecordingSettings
{
	...
	unsigned char                                      UnknownData_93M7[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_LWO0[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_OIH5[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QMVG[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_RIMV[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VKI4[0x14];                                    // 0x0094(0x0014) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_GUTU[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_UK1C[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_4VKO[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_SM3Z[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_67MY[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_US11[0x8];                                     // 0x0108(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_C4GD[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKFloorContact : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_QFID[0x2];                                     // 0x004E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EWL6[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKLookAt : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_YMSD[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HUBH[0x17];                                    // 0x0071(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKOffset : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_QBFZ[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKPin : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_BSOM[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKPlant : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_3TL4[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_USPH[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKPull : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_A718[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKReach : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_BQ9H[0x2];                                     // 0x0072(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AYUS[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKReachRotator : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_38WO[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKRelativePlant : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_9SBW[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKResist : public FAnimNode_HIKBase
{
	float                                              Alpha;                                                     // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<Engine_EHIKEffector>                   Effector;                                                  // 0x004C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_I9CP[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKSetProperty : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_XBLG[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Alpha;                                                     // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_7KJ7[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZEGT[0x5];                                     // 0x007B(0x0005) MISSED OFFSET (PADDING)
...
struct FAnimNode_HIKTest : public FAnimNode_HIKBase
{
	...
	unsigned char                                      UnknownData_KHYV[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_SGLF[0x26];                                    // 0x007A(0x0026) MISSED OFFSET (PADDING)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_83BV[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FInputScaleBias                             AlphaScaleBias;                                            // 0x0054(0x0008) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_5AHM[0x14];                                    // 0x005C(0x0014) MISSED OFFSET (PADDING)
...
struct FAnimNode_RefPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_HIYB[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_4LLA[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FEditorImportExportTestDefinition
{
	...
	unsigned char                                      UnknownData_32X5[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      UnknownData_1LHV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData_TLMZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LDBP[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<Engine_EParticleEventType>             Type;                                                      // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_1SGB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                Frequency;                                                 // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_HM96[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UParticleModuleEventSendToGame*>      ParticleModuleEventsToSendToGame;                          // 0x0018(0x0010) (Edit, ExportObject, ZeroConstructor, ContainsInstancedReference)
...
struct FOpenTestAsset
{
	...
	unsigned char                                      UnknownData_97WT[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FKConvexElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_XUJ7[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0050(0x0030) (IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_S7ZF[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
...
struct FKAggregateGeom
{
	...
	unsigned char                                      UnknownData_S20N[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IDBM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimationNode_TwoWayBlend : public FAnimNode_Base
{
	...
	float                                              Alpha;                                                     // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FInputScaleBias                             AlphaScaleBias;                                            // 0x0064(0x0008) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_P8M4[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AIPZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FGOZ[0x6A];                                    // 0x0000(0x006A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SL01[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QMZ1[0xC0];                                    // 0x0000(0x00C0) MISSED OFFSET (PADDING)
...
struct FServerMigrationTelemetryActorData
{
	...
	unsigned char                                      UnknownData_CRS8[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_FVA8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FReplicatedPhysicsState
{
	...
	unsigned char                                      UnknownData_HUNO[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FReplicatedTransformState
{
	...
	unsigned char                                      UnknownData_CM0M[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K3XB[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1XOL[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData_ZVDT[0x2F];                                    // 0x0039(0x002F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1NKG[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
...
struct FFogVolumeInfo
{
	...
	unsigned char                                      UnknownData_OGWU[0xF8];                                    // 0x0008(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2KOK[0x20];                                    // 0x0110(0x0020) MISSED OFFSET (PADDING)
...
struct FWaterSimPlane
{
	...
	unsigned char                                      UnknownData_JH9L[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EFPT[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FBatchedPoint
{
	...
	unsigned char                                      UnknownData_IRQI[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FBatchedLine
{
	...
	unsigned char                                      UnknownData_IG6S[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FAssetEditorOrbitCameraPosition
{
	...
	unsigned char                                      UnknownData_9S0R[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_996M[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMeshSectionInfo
{
	...
	unsigned char                                      UnknownData_OYFP[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FPresortedBillboardsParams
{
	...
	unsigned char                                      UnknownData_MA7L[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_TQN3[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VHNF[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      UnknownData_02FO[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0YJD[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSimplygonMaterialLODSettings               MaterialLODSettings;                                       // 0x0028(0x0028) (Edit)
	...
	unsigned char                                      UnknownData_00NZ[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
struct FStaticMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_3439[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              NumOfTrianglesPercentage;                                  // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              MaxDeviationPercentage;                                    // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              WeldingThreshold;                                          // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               bRecalcNormals;                                            // 0x0010(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_XRCD[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              NormalsThreshold;                                          // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_0OQW[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1ZNR[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3YRJ[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y34V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IS5K[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_986S[0x140];                                   // 0x0000(0x0140) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZSXI[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ACF3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_46XR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A1IH[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q9R1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownData_5JKE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoolTrackKey
{
	...
	unsigned char                                      UnknownData_5BKC[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      UnknownData_QZ8K[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1I13[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FMeshProxySettings
{
	...
	unsigned char                                      UnknownData_987Z[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RRP4[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_INOB[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S06W[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F34C[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TW4O[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                BaseNonRenderedUpdateRate;                                 // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MF04[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOverlapResult
{
	...
	unsigned char                                      UnknownData_5D62[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD (NoDestructor)
	unsigned char                                      UnknownData_U28Y[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSwarmDebugOptions
{
	...
	unsigned char                                      UnknownData_MBDU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassDebugOptions
{
	...
	unsigned char                                      UnknownData_EKKV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WI33[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRotationAboutAxisParameters
{
	...
	unsigned char                                      UnknownData_NE7I[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      UnknownData_R0YN[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GYNF[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HZLX[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RSY4[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XG8B[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3VRP[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8240[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownData_G9CB[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIntegralCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_XNPJ[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QZ3P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPreviewAttachedObjectPair
{
	...
	unsigned char                                      UnknownData_YGEK[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBoneMirrorExport
{
	...
	unsigned char                                      UnknownData_POEC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationGroupReference
{
	...
	unsigned char                                      UnknownData_19MH[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimExtractContext
{
	...
	unsigned char                                      UnknownData_HODP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5GY4[0x68];                                    // 0x0000(0x0068) MISSED OFFSET (PADDING)
...
struct FDamageEvent
{
	unsigned char                                      UnknownData_0I1A[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_DO9U[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData_YH7U[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MYIM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XPPN[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FVelocityConeGroupParams
{
	...
	unsigned char                                      UnknownData_2FU5[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FDestructibleDamageParameters
{
	...
	unsigned char                                      UnknownData_CP6M[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2JVF[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDestructibleSpecialHierarchyDepths
{
	...
	unsigned char                                      UnknownData_HEHD[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDestructibleParametersFlag
{
	...
	unsigned char                                      UnknownData_N5Z7[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FDestructibleParameters
{
	...
	unsigned char                                      UnknownData_LL4N[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XS6C[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData_ZTFO[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y48P[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGPUSpriteLocalVectorFieldInfo
{
	...
	unsigned char                                      UnknownData_A2WP[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQ8V[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
struct FGPUSpriteEmitterInfo
{
	...
	unsigned char                                      UnknownData_4SQM[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y601[0x1];                                     // 0x0187(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_476J[0x3];                                     // 0x0189(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QJ5U[0x3];                                     // 0x018D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_74GJ[0x17];                                    // 0x0289(0x0017) MISSED OFFSET (PADDING)
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData_MYV2[0x1];                                     // 0x020B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector2D                                   PivotOffset;                                               // 0x020C(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_N10G[0x464];                                   // 0x0214(0x0464) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              AlignmentInheritedVelocityScale;                           // 0x0678(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_VAUC[0x194];                                   // 0x067C(0x0194) MISSED OFFSET (PADDING)
...
struct FTTTrackBase
{
	...
	unsigned char                                      UnknownData_07UY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H38A[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6WUY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_PITT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_JJVB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBeamModifierOptions
{
	...
	unsigned char                                      UnknownData_YWMU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      UnknownData_2VTV[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOrbitOptions
{
	...
	unsigned char                                      UnknownData_LPNB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleBurst
{
	...
	unsigned char                                      UnknownData_9CAH[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FExposureSettings
{
	...
	unsigned char                                      UnknownData_I122[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VPQT[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FDepthFieldGlowInfo
{
	...
	unsigned char                                      UnknownData_4G0Z[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontRenderInfo
{
	...
	unsigned char                                      UnknownData_IPYN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FComponentReference
{
	...
	unsigned char                                      UnknownData_225I[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FNode
{
	...
	unsigned char                                      UnknownData_F73S[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceDelegateResult
{
	...
	unsigned char                                      UnknownData_3U58[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZTIJ[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_OW2Y[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_2DE2[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_4QDB[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              PlayRate;                                                  // 0x004C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_X7Q3[0xB];                                     // 0x0055(0x000B) MISSED OFFSET (PADDING)
...
struct FAnimNode_Slot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_A0K7[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D7ZR[0x6];                                     // 0x005A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_QFZ8[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5XQZ[0x60];                                    // 0x0048(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6W0M[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5PR1[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_TransitionPoseEvaluator : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_7KHX[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NF6G[0x40];                                    // 0x0038(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                CacheFramesRemaining;                                      // 0x0078(0x0004) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ANFB[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_7SBX[0xF];                                     // 0x0031(0x000F) MISSED OFFSET (PADDING)
...
struct FMergedCollisionActorsSimplification
{
	...
	unsigned char                                      UnknownData_N7J9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData_6LXH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6GLJ[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5KXO[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FSpriteCategoryInfo
{
	...
	unsigned char                                      UnknownData_HZWR[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       Description;                                               // 0x0040(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_DVO7[0x20];                                    // 0x0040(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTriMeshCollisionData
{
	...
	unsigned char                                      UnknownData_38JH[0x17];                                    // 0x0021(0x0017) MISSED OFFSET (PADDING)

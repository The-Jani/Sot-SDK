...
public:
	...
	class UIslandTelemetrySubjectComponent*            IslandTelemetrySubject;                                    // 0x0528(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)

...
struct FStatus
{
	...
	unsigned char                                      UnknownData_5X3U[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FDelayedStatusEffect
{
	...
	unsigned char                                      UnknownData_PI5I[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D940[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FActiveStatusEffect
{
	...
	unsigned char                                      UnknownData_8G3U[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1JEU[0x17];                                    // 0x0039(0x0017) MISSED OFFSET (PADDING)

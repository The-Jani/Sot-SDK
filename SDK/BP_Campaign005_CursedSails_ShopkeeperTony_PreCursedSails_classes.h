...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_ShopkeeperTony_PreCursedSails.BP_Campaign005_CursedSails_ShopkeeperTony_PreCursedSails_C");
		return ptr;
	}

...
public:
	...
	unsigned char                                      UnknownData_W5V7[0x3];                                     // 0x00ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ETOU[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PVUD[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PT2L[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JD56[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N86Q[0x68];                                    // 0x0400(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_43QO[0x38];                                    // 0x0060(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J38M[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XOY3[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N87X[0x50];                                    // 0x0088(0x0050) MISSED OFFSET (PADDING)

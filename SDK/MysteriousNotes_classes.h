...
public:
	...
	unsigned char                                      UnknownData_LBWP[0x20];                                    // 0x0028(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       DefaultBody;                                               // 0x0060(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_3UED[0x20];                                    // 0x0060(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_VUT8[0x28];                                    // 0x03D0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CGBB[0x88];                                    // 0x0410(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q615[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_01ZH[0x14E];                                   // 0x00EA(0x014E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QQ4Q[0x10];                                    // 0x0770(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_643D[0x54];                                    // 0x079C(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RYHG[0x118];                                   // 0x0808(0x0118) MISSED OFFSET (PADDING)

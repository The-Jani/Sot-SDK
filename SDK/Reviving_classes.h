...
public:
	...
	unsigned char                                      UnknownData_VTFE[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VPGG[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TFEC[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               HasGivenUp;                                                // 0x0120(0x0001) (Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor)
	unsigned char                                      UnknownData_W44G[0x57];                                    // 0x0121(0x0057) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F9LH[0x18];                                    // 0x02E8(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CI20[0x10];                                    // 0x0118(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DO1A[0x6];                                     // 0x013A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YU9V[0xC];                                     // 0x0148(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               ReviveWindowIsOpen;                                        // 0x0154(0x0001) (Net, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_E9A5[0xD3];                                    // 0x0155(0x00D3) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStatus                                     RevivableStatus;                                           // 0x0228(0x0018) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_JCDI[0x18];                                    // 0x0240(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PZQB[0x98];                                    // 0x00C8(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JK9Q[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HKVN[0x10];                                    // 0x0428(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NKG4[0x7];                                     // 0x0439(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_41FE[0x13C];                                   // 0x04A0(0x013C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LS29[0x1C];                                    // 0x05EC(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7I9G[0x4];                                     // 0x0624(0x0004) MISSED OFFSET (PADDING)

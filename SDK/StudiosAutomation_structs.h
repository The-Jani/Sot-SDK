...
struct FAssetAuditConstantEntry
{
	...
	unsigned char                                      UnknownData_9FF6[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FCollectionLimits
{
	...
	unsigned char                                      UnknownData_054Q[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S84O[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (PADDING)
...
struct FFolderTotals
{
	...
	unsigned char                                      UnknownData_FZ6U[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_5LQD[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_PRSU[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DRMT[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_I4ST[0x5];                                     // 0x0073(0x0005) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QQUL[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8OUW[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8I6G[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6VO7[0xB];                                     // 0x00C5(0x000B) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_NI74[0x2];                                     // 0x008E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_HandIKRetargeting : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_44K3[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_Trail : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_IFWP[0x1];                                     // 0x006B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4WNM[0x5F];                                    // 0x0081(0x005F) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_VE4A[0x3];                                     // 0x008D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5G3A[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KEZS[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_FWQK[0x2];                                     // 0x0076(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_E2N1[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2LK8[0x29];                                    // 0x007F(0x0029) MISSED OFFSET (PADDING)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_Z6GZ[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JZYJ[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8ESE[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9SYH[0x2];                                     // 0x009A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O7U0[0x3];                                     // 0x009D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_WBJI[0x1];                                     // 0x007F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GDID[0x3];                                     // 0x0085(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AE0U[0x2F];                                    // 0x0091(0x002F) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_SOCI[0x87];                                    // 0x0039(0x0087) MISSED OFFSET (PADDING)
